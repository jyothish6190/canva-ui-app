...
export const getValue = (component: Component) => {
    ...
    if (component.fields) {
        component.fields?.forEach((field: Component) => {
            if (field.name === FormFieldSelectFieldNames.SELECT_OPTIONS) {
...
export const getSelectedValue = (component: Component) => {
    let value = '';
    component.fields?.forEach((field: Component) => {
        if (field.name === FormFieldSelectFieldNames.PLACEHOLDER) {
            value = field.value;
        }
    });
...
export const getActive = (component: Component) => {
    ...
    component.fields?.forEach((field: Component) => {
        if (field.name === FormFieldSelectFieldNames.ACTIVE) {
            state = field.value;
        }
    });
...
export const getDescription = (component: Component) => {
    let state = '';
    component.fields?.forEach((field: Component) => {
...
export const getWidth = (component: Component) => {
    ...
    component.fields?.forEach((field: Component) => {
        if (field.name === FormFieldSelectFieldNames.WIDTH) {
